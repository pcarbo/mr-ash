...
The (approximate) EM algorithm seems to have identified a local
maximum at around $\pi = 0.25$, whereas the true setting is nearly
$\pi = 0.5$:
...
Indeed, the highest point in the ELBO is around $\pi = 0.25$, and it
drops off rapidly at larger values:
